  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-0">
        <h1 className="text-center text-3xl font-bold tracking-tight text-red-900 sm:text-4xl">Shopping Cart</h1>
        ...
        <form className="mt-12">
                ...
                <li key={product.id} className="flex py-6">
                  ...
                  <div className="ml-4 flex flex-1 flex-col sm:ml-6">
                    ...
                    <div className="mt-4 flex flex-1 items-end justify-between">
                      ...
                      <div className="ml-4">
                        <button type="button" className="text-sm font-medium text-red-600 hover:text-black/80">
                          <span>Remove</span>
                        </button>
                      </div>
                    </div>
          ...
          <section aria-labelledby="summary-heading" className="mt-10">
            ...
            <div className="mt-10">
              <button
                type="submit"
                className="w-full rounded-md border border-transparent bg-black px-4 py-3 text-base font-medium text-white shadow-sm hover:text-black hover:bg-pink-200 focus:outline-none focus:ring-2 focus:ring-black/80 focus:ring-offset-2 focus:ring-offset-gray-50"
              >
                Checkout
              </button>
            </div>
